            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item <?php if ($title == 'Kelolah Data Pelanggan') {
                                                echo 'active';
                                            } ?>">
                        ...
                        <li class="nav-item <?php if ($title == 'Kelolah Data Paket') {
                                                echo 'active';
                                            } ?>"">
                            <a href=" paket.php">
                        ...
                        <li class="nav-item <?php if ($title == 'Kelolah Data Pengguna') {
                                                echo 'active';
                                            } ?>">
                            <a href="pengguna.php">
