...
// Menampilkan transaksi dalam 7 hari terakhir
$query = "SELECT transaksi.*, pelanggan.nama_pelanggan, detail_transaksi.total_harga 
          ...
          WHERE transaksi.tgl >= DATE_SUB(CURDATE(), INTERVAL 7 DAY)";
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="tambah_pelanggan.php" class="btn btn-primary btn-round ml-auto mr-2">
                            <i class="fa fa-plus"></i>
                            Tambah Pelanggan
                        </a>
                        <a href="cari.php" class="btn btn-primary btn-round mr-2">
                            <i class="fa fa-plus"></i>
                            Tambah Transaksi
                        </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="detail.php?id=<?= $trans['id_transaksi']; ?>" class="btn btn-primary" data-toggle="tooltip" title="Detail">
